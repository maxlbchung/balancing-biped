...
namespace BipedGeneration2
{
    public class LegRig
    {
        ...
        public int layoutSign;
        public int outwardSign;
    }

    public interface IBipedController
    {
        void SetRig(Rigidbody2D bodyRb, LegRig left, LegRig right);
    }

    public class BipedNametag : MonoBehaviour
    {
        void LateUpdate()
        {
    ...
    public class BipedSpawner : MonoBehaviour
    {
        ...
        void OnValidate()
        {
            ...
            foreach (var s in bipedControllerScripts)
            {
                ...
                if (!valid)
                {
                    Debug.LogWarning($"BipedSpawner: '{s.name}' is not a MonoBehaviour implementing IBipedController and will be skipped.", this);
                }
            }
        }
#endif
        ...
        void AttachController(GameObject host, Type controllerType, Rigidbody2D body, LegRig left, LegRig right)
        {
            ...
            {
                Debug.LogWarning($"BipedSpawner: '{controllerType.Name}' does not implement IBipedController — skipping SetRig.", this);
            }
        }
