...
{
    public class BipedNaturalResistance : MonoBehaviour, IBipedController
    {
        // Gains and torques below are computed from the default Spawner rig per the
        // procedures in references/mass-calculation.md and references/inertia-calculation.md.
        //
        ...
        // Recompute per SKILL.md Step 3.2 / 3.3 when the rig changes.
